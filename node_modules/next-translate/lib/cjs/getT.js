...
function getT(locale, namespace) {
    ...
    return __awaiter(this, void 0, void 0, function () {
        var config, defaultLoader, lang, loader, allNamespaces, _a, localesToIgnore, ignoreLang, pluralRules, t;
        var _b;
        var _this = this;
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 1:
                    allNamespaces = (_b[_a] = _c.sent(), _b);
                    ...
                    return [2, (0, wrapTWithDefaultNs_1.default)(t, namespace)];
            }
        });
    });
}
