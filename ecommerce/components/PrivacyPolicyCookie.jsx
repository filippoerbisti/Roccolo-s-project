...
const PrivacyPolicyCookie = () => {
  return (
    <div className={styles.policy}>
        ...
        <li>
        <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to Roccolo del Lago.</p>
        </li>
        <li>
        ...
        <li>
        <p><strong>Website</strong> refers to Roccolo del Lago, accessible from <a href="https://pr1-smoky.vercel.app" rel="external nofollow noopener" target="_blank">https://pr1-smoky.vercel.app</a></p>
        </li>
        <li>
        ...
        <ul>
        <li>
        <p>By email: <a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="f7919e9b9e878798d99285959e84839eb7909a969e9bd994989a">[email&#160;protected]</a></p>
        </li>
        <li>
        <p>By visiting this page on our website: <a href="https://pr1-smoky.vercel.app/contact" rel="external nofollow noopener" target="_blank">https://pr1-smoky.vercel.app/contact</a></p>
        </li>
