    ...
    <div className={styles.mx60}>
        ...
        <div className={styles.policy}>
          ...
          <ul>
            ...
            <li>
              <p><strong>Website</strong> refers to Roccolo del Lago, accessible from <a href="https://roccolodellago.vercel.app" rel="external nofollow noopener" target="_blank">https://roccolodellago.vercel.app</a></p>
            </li>
            <li>
