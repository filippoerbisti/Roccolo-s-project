...
import dataWineShopGallery from '../store/dataWineShopGallery';
...
const WineShopGalleries = () => {
  const data = dataWineShopGallery;
  ...
  return (
    <div ref={ref} className={styles.list} style={{ height: Math.max(...heights) }}>
      {transitions((style, item) => (
        <a.div style={style} href={item.css}>
...
export default WineShopGalleries