    ...
    <div className={styles.mx60}>
        ...
        <div className={styles.policy}>
          ...
          <ul>
            ...
            <li>
              <p><strong>Website</strong> refers to Roccolo del Lago, accessible from <Link href={"/"} target="_blank" rel="noreferrer">https://roccolodellago.vercel.app</Link></p>
            </li>
            <li>
          ...
          <ul>
            <li>
              <p>By email: <a href={`mailto:${mailTo}`} rel="noopener noreferrer" className="__cf_email__">filippo.erbisti@gmail.com</a></p>
            </li>
            <li>
              <p>By visiting this page on our website: <Link href="/contact"  target="_blank" rel="noreferrer">https://roccolodellago.vercel.app/contact</Link></p>
            </li>
          </ul>
        </div>
    </div>
